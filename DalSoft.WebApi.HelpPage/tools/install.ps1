# Credit to http://www.rhyous.com/2015/05/14/setting-file-properties-in-a-nuget-package-build-action-copy-to-output-directory-custom-tool/
...
SetFilePropertiesRecursively $project.ProjectItems.Item("Help")